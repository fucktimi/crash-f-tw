...
RUN apk --no-cache --update add ca-certificates libcap tzdata curl cargo && \
	...
	rm -rf /var/cache/apk/* && \
    mkdir /crashfever && \
    curl -L -o zstandard.whl https://files.pythonhosted.org/packages/bc/e3/11d05c62ade3896b74b0a42f8c8821f6d45e5565302ad2b0d1917aaa2eb3/zstandard-0.20.0-cp311-cp311-manylinux_2_17_x86_64.manylinux2014_x86_64.whl && \
    pip3 install zstandard.whl && \
